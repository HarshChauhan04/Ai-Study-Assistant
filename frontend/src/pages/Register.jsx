    ...
    <div className="min-h-screen flex bg-slate-50 dark:bg-[#080c14]">
      ...
      <div className="hidden lg:flex lg:w-[45%] xl:w-[50%] relative overflow-hidden flex-col justify-between p-12" style={{
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-[15%] right-[20%] h-[300px] w-[300px] rounded-full bg-blue-400/20 blur-[80px]" />
          <div className="absolute bottom-[15%] left-[10%] h-[250px] w-[250px] rounded-full bg-teal-400/15 blur-[60px]" />
          ...
          <div className="space-y-4">
            {perks.map((p) => (
              <div key={p.text} className="flex items-center gap-3">
                ...
                <span className="text-sm text-blue-100/90 font-medium">{p.text}</span>
              </div>
            ))}
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 relative overflow-y-auto">
        ...
        <div className="w-full max-w-md" style={{ animation: 'slide-up 0.5s cubic-bezier(0.16, 1, 0.3, 1) forwards' }}>
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3.5 rounded-xl border bg-white dark:bg-[#0e1525] text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-600 outline-none transition-all text-sm font-medium ${
                    confirmPassword && password !== confirmPassword
                      ...
                      : 'border-slate-200 dark:border-slate-700/60 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/15'
                  }`}
                />
                {confirmPassword && (
          ...
          <div className="text-center text-sm text-slate-600 dark:text-slate-400">
            ...
            <Link to="/login" className="font-bold text-blue-600 dark:text-blue-400 hover:underline underline-offset-2">
              Sign in
            </Link>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-slate-400 dark:text-slate-600">
            ...
            <a href="#" className="underline hover:text-blue-600 dark:hover:text-blue-400">Terms of Service</a>
            {' '}and{' '}
